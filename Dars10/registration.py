...
oyna.configure(bd=2)
oyna.iconbitmap("images/icon_oyna.ico")
...
back_g = Frame(oyna, width=500, height=450, bg='white')
back_g.place(x=150,y=80)
...
btn1 = Button(back_g, text='Sign up', font=('Segoe Script', 15),activebackground='white', bd=0, bg='white', command=Signup)
...
def Done1():
    ...
    if user_data[2]== login and user_data[3] == password:
        oyna = Toplevel()
